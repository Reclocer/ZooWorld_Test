...
namespace SUBS.Core.ResourceManagement
{
    public static class AddressableHelper
    {
        ...
        public static AddressableAssetEntry CreatAssetEntryAndSave<T>(T source, string groupName) 
            where T : Object
        {
            AddressableAssetEntry entry = CreateAssetEntry(source, groupName);
            AssetDatabase.SaveAssets();
            AssetDatabase.Refresh();
            return entry;
        }

        public static AddressableAssetEntry CreateAssetEntry<T>(T source, string groupName) 
            where T : Object
        {
            ...
            AddressableAssetEntry entry = addressableSettings.CreateOrMoveEntry(sourceGuid, group);
            entry.address = source.name;
        ...
        public static AddressableAssetEntry CreateAssetEntry<T>(T source) 
            where T : Object
        {
