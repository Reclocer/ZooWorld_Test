...
namespace CodeStage.AntiCheat.ObscuredTypes.EditorCode
{
	...
	public abstract class SerializedObscuredType<T> : ISerializedObscuredType
	{
		...
		public ISerializableObscuredType TargetInstance => _targetInstance ?? (_targetInstance = Target.GetValue<ISerializableObscuredType>());
		...
		{
			return TargetInstance.IsDataValid;
		}
	}
}
